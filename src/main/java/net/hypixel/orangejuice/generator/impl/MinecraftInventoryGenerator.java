...
import net.hypixel.orangejuice.generator.image.ImageCoordinates;
import net.hypixel.orangejuice.generator.item.GeneratedObject;
import net.hypixel.orangejuice.generator.item.InventoryItem;
import net.hypixel.orangejuice.generator.parser.inventory.InventoryStringParser;
...
import static net.hypixel.orangejuice.util.Util.initFont;
