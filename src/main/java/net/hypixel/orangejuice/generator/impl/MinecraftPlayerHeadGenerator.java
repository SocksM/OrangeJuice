...
import net.hypixel.orangejuice.generator.skull.RenderedPlayerSkull;
...
public class MinecraftPlayerHeadGenerator implements Generator {
    ...
    private static String base64ToSkinURL(String base64SkinData) {
        JsonObject skinData = NerdBotApiApp.GSON.fromJson(new String(Base64.getDecoder().decode(base64SkinData)), JsonObject.class);
